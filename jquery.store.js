(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Tohfa"; // Prefix string to be prepended to the cart's name in the session storage
		...
		createCart: function() {
			if( this.storage.getItem( this.cartName ) == null ) {
				...
				this.storage.setItem( this.shippingRates, "100" );
		...
		displayUserDetails: function() {
			if( this.$userDetails.length ) {
				if( this.storage.getItem( "shipping-name" ) == null ) {
					...
					var choice = this.storage.getItem( "billing-choice" )
		...
		_saveFormData: function( form ) {
			...
			$visibleSet.each(function() {
				...
				if( $set.is( "#fieldset-billing" ) ) {
					...
					self.storage.setItem( "billing-choice", choice );
				} else {
